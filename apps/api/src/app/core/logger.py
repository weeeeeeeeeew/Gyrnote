...
def file_log_filter_processors(_: WrappedLogger, __: str, event_dict: EventDict) -> EventDict:
...
def console_log_filter_processors(_: WrappedLogger, __: str, event_dict: EventDict) -> EventDict:
    """Filter out the request ID, path, method, client host, and status code from the event dict if the
    corresponding setting is False."""
