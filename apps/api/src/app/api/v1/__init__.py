...
from .graph_recalls import router as graph_recalls_router
from .health import router as health_router
from .instruction_patches import router as instruction_patches_router
from .login import router as login_router
from .logout import router as logout_router
from .note_answers import router as note_answers_router
...
router.include_router(note_answers_router)
...
router.include_router(graph_recalls_router)
